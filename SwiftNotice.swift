...
class SwiftNotice: NSObject {
    ...
    static func noticeOnStatusBarGreenBackground(text: String, autoClear: Bool, autoClearTime: Int) {
    ...
    static func noticeOnStatusBarRedBackground(text: String, autoClear: Bool, autoClearTime: Int) {
        let frame = UIApplication.sharedApplication().statusBarFrame
        let window = UIWindow()
        window.backgroundColor = UIColor.clearColor()
        let view = UIView()
